...
$admNo=$row['admNo'];
echo "<td width='3%'>"."<center><img width='120' height='120' src=passport/".$row['admNo']."".$row['passportPhoto'].">";
echo "<td width='3%' style=>"."<center>".$row['admNo']."</td>";
echo "<td width='3%'>"."<center>".$row['name']."</td>";
echo "<td width='3%'>";
echo "<center><a href='viewCustomer_pro.php?admno=$admNo&edit=Search'>View More</a>";
echo "</td>";
echo "</tr>";
}
echo "</table></center>";
